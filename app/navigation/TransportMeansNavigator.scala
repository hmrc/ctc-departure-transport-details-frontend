...
@Singleton
class TransportMeansNavigatorProviderImpl @Inject() (implicit appConfig: FrontendAppConfig) extends TransportMeansNavigatorProvider {
...
class TransportMeansNavigator(override val mode: Mode)(implicit override val appConfig: FrontendAppConfig) extends UserAnswersNavigator {
