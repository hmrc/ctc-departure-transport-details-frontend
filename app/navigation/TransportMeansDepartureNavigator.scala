...
@Singleton
class TransportMeansDepartureNavigatorProviderImpl @Inject() (implicit appConfig: FrontendAppConfig, phaseConfig: PhaseConfig)
    extends TransportMeansDepartureNavigatorProvider {
