...
import pages.transportMeans.active.ConveyanceReferenceNumberYesNoPage
import play.api.i18n.{I18nSupport, MessagesApi}
import play.api.mvc.{Action, AnyContent, MessagesControllerComponents}
import repositories.SessionRepository
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendBaseController
import views.html.transportMeans.active.ConveyanceReferenceNumberYesNoView
...
class ConveyanceReferenceNumberYesNoController @Inject() (
  ...
  private val form = formProvider("transportMeans.active.conveyanceReferenceNumberYesNo")
