...
class AddIdentificationNumberYesNoController @Inject() (
  ...
  def onPageLoad(lrn: LocalReferenceNumber, mode: Mode): Action[AnyContent] = actions.requireData(lrn) {
    implicit request =>
      val preparedForm = request.userAnswers.get(AddIdentificationNumberYesNoPage) match {
        case None        => form
      ...
      form
        ...
        .fold(
          ...
          value => {
            ...
            AddIdentificationNumberYesNoPage.writeToUserAnswers(value).updateTask().writeToSession().navigate()
          }
        )
  }
}
