...
import views.html.transportMeans.AnotherVehicleCrossingYesNoView
      ...
      form
        ...
        .fold(
          ...
          value => {
            ...
            AnotherVehicleCrossingYesNoPage.writeToUserAnswers(value).updateTask().writeToSession().navigate()
          }
        )
  }
}
