...
import pages.preRequisites.UniqueConsignmentReferencePage
import play.api.i18n.{I18nSupport, MessagesApi}
import play.api.mvc.{Action, AnyContent, MessagesControllerComponents}
import repositories.SessionRepository
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendBaseController
import views.html.preRequisites.UniqueConsignmentReferenceView
      ...
      form
        ...
        .fold(
          ...
          value => {
            ...
            UniqueConsignmentReferencePage.writeToUserAnswers(value).updateTask().writeToSession(sessionRepository).navigateWith(navigator)
          }
        )
  }
}
