...
package views.additionalReference
...
class AddAdditionalReferenceYesNoViewSpec extends YesNoViewBehaviours {
  ...
  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector.instanceOf[AddAdditionalReferenceYesNoView].apply(form, lrn, NormalMode)(fakeRequest, messages)

  override val prefix: String = "additionalReference.addAdditionalReferenceYesNo"
