...
class AddIdentificationYesNoViewSpec extends YesNoViewBehaviours {
  ...
  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector.instanceOf[AddIdentificationYesNoView].apply(form, lrn, NormalMode, activeIndex)(fakeRequest, messages)

  override val prefix: String = "transportMeans.active.addIdentificationYesNo"
