...
package views.equipment.index.seals
...
class IdentificationNumberViewSpec extends InputTextViewBehaviours[String] {
  ...
  override val prefix: String     = "equipment.index.seals.identificationNumber"
  override def form: Form[String] = new SealIdentificationNumberFormProvider()(prefix, Nil)
