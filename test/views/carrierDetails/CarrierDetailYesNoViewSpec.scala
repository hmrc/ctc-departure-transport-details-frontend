...
class CarrierDetailYesNoViewSpec extends YesNoViewBehaviours {

  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector.instanceOf[CarrierDetailYesNoView].apply(form, lrn, NormalMode)(fakeRequest, messages)

  override val prefix: String = "carrierDetails.carrierDetailYesNo"
