...
class CountryOfDispatchControllerSpec extends SpecBase with AppWithDefaultMockFixtures with Generators {
  ...
  private val form         = formProvider("preRequisites.countryOfDispatch", countryList)
  ...
  "CountryOfDispatch Controller" - {
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request   = FakeRequest(POST, countryOfDispatchRoute).withFormUrlEncodedBody((field, "invalid value"))
