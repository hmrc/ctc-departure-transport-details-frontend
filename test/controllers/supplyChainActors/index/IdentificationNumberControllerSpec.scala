  ...
  "IdentificationNumber Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual
        view(form, lrn, mode, actorIndex, supplyChainActor.toString.toLowerCase)(request, messages).toString
    }
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(filledForm, lrn, mode, actorIndex, supplyChainActor.toString.toLowerCase)(request, messages).toString
    }
