...
class SupplyChainActorTypeControllerSpec extends SpecBase with AppWithDefaultMockFixtures with Generators {
  ...
  private val supplyChainActorType  = supplyChainActorTypes.head

  private val formProvider                   = new EnumerableFormProvider()
  private val form                           = formProvider[SupplyChainActorType]("supplyChainActors.index.supplyChainActorType", supplyChainActorTypes)
  ...
  "SupplyChainActorType Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual
        view(form, lrn, supplyChainActorTypes, mode, actorIndex)(request, messages).toString
    }

    "must populate the view correctly on a GET when the question has previously been answered" in {

      val userAnswers = emptyUserAnswers.setValue(SupplyChainActorTypePage(actorIndex), supplyChainActorType)
      ...
      contentAsString(result) mustEqual
        view(filledForm, lrn, supplyChainActorTypes, mode, actorIndex)(request, messages).toString
    }
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, lrn, supplyChainActorTypes, mode, actorIndex)(request, messages).toString
    }
