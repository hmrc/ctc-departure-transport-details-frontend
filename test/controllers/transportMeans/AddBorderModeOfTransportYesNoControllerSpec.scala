...
class AddBorderModeOfTransportYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar {
  ...
  private lazy val addBorderModeOfTransportYesNoRoute = routes.AddBorderModeOfTransportYesNoController.onPageLoad(lrn, mode).url
  ...
  "AddBorderModeOfTransportYesNo Controller" - {
