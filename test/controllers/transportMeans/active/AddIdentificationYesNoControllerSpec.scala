...
class AddIdentificationYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar {

  private val formProvider                     = new YesNoFormProvider()
  private val form                             = formProvider("transportMeans.active.addIdentificationYesNo")
  private val mode                             = NormalMode
  private lazy val addIdentificationYesNoRoute = routes.AddIdentificationYesNoController.onPageLoad(lrn, mode, activeIndex).url
  ...
  "AddNationalityYesNo Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.setValue(AddIdentificationYesNoPage(activeIndex), true)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request = FakeRequest(POST, addIdentificationYesNoRoute)
