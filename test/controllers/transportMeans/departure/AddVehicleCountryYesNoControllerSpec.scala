...
import views.html.transportMeans.departure.AddVehicleCountryYesNoView

import scala.concurrent.Future

class AddVehicleCountryYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar {
  ...
  "AddIdentificationNumberYesNo Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request = FakeRequest(POST, addVehicleCountryYesNoRoute)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request   = FakeRequest(POST, addVehicleCountryYesNoRoute).withFormUrlEncodedBody(("value", ""))
