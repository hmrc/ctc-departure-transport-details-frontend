...
package controllers.equipment.index.itemNumber
...
import pages.sections.equipment.ItemNumberSection
import pages.equipment.index.itemNumber.ItemNumberPage
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.equipment.index.itemNumber.RemoveItemNumberYesNoView
...
class RemoveItemNumberYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with Generators {
  ...
  private val form                            = formProvider("equipment.index.itemNumber.removeItemNumberYesNo", itemNumber)
    ...
    "must redirect to the next page" - {
      "when yes is submitted" in {
        ...
        redirectLocation(result).value mustEqual
          controllers.equipment.index.routes.AddAnotherGoodsItemNumberController.onPageLoad(userAnswers.lrn, mode, equipmentIndex).url
