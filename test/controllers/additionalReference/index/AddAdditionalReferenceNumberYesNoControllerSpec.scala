...
import pages.additionalReference.index.AddAdditionalReferenceNumberYesNoPage
...
class AddAdditionalReferenceNumberYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar {
  ...
  private val form         = formProvider("additionalReference.index.addAdditionalReferenceNumberYesNo")
  private val mode         = NormalMode

  private lazy val addAdditionalReferenceNumberYesNoRoute =
    routes.AddAdditionalReferenceNumberYesNoController.onPageLoad(lrn, mode, additionalReferenceIndex).url
  ...
  "AddAdditionalReferenceNumberYesNo Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.setValue(AddAdditionalReferenceNumberYesNoPage(additionalReferenceIndex), true)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, lrn, mode, additionalReferenceIndex)(request, messages).toString
    }
