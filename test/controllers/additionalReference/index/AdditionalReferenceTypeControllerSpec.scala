...
class AdditionalReferenceTypeControllerSpec extends SpecBase with AppWithDefaultMockFixtures with Generators {
  ...
  private val additionalReference1    = arbitraryAdditionalReferenceType.arbitrary.sample.get
  private val additionalReference2    = arbitraryAdditionalReferenceType.arbitrary.sample.get
  private val additionalReferenceList = SelectableList(Seq(additionalReference1, additionalReference2))

  private val formProvider = new SelectableFormProvider()
  private val form         = formProvider("additionalReference.index.additionalReferenceType", additionalReferenceList)
  ...
  "AdditionalReferenceType Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, additionalReferenceTypeRoute)
      ...
      contentAsString(result) mustEqual
        view(form, lrn, additionalReferenceList.values, mode, additionalReferenceIndex)(request, messages).toString
    }
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(filledForm, lrn, additionalReferenceList.values, mode, additionalReferenceIndex)(request, messages).toString
    }
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request = FakeRequest(POST, additionalReferenceTypeRoute)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request   = FakeRequest(POST, additionalReferenceTypeRoute).withFormUrlEncodedBody(("value", "invalid value"))
      ...
      contentAsString(result) mustEqual
        view(boundForm, lrn, additionalReferenceList.values, mode, additionalReferenceIndex)(request, messages).toString
    }
